        ...
        return(
            ...
            <div className="container-fluid p-0 m-0" style={{height:'100vh',width:'100vw',textAlign:'center',}}>
                ...
                <div className='container-fluid m-0' style={centerCon}>
                    <BarChart width={this.state.w} height={this.state.h}  data={this.state.vacations}>
                    <XAxis dataKey="name" stroke="#d02552" />
                        <YAxis />
                        <Tooltip wrapperStyle={{ width: 120, backgroundColor: '#ccc' , color:'#50d07d' }} />
                        <Legend 
                         width={150} 
                         wrapperStyle={{ top: 40, right: 20, backgroundColor: '#f5f5f5', border: '1px solid #d02552', borderRadius: 3, lineHeight: '40px' }}
                        />
                        <CartesianGrid stroke="rgba(208, 37, 82,0.2)" strokeDasharray="5 5" />
                        <Bar type="monotone" dataKey="Followers" fill="#d02552" barSize={40} />
                    </BarChart>
                </div>
                <div className="row">
                    <Link className='offset-xl-5 offset-lg-5 offset-md-4 offset-2' to="/" style={{position:'absolute',top:'94vh'}} >
                        <button className='btn btn-outline-success btn-block' style={{width:'270px'}}>Back</button>
                    </Link>
                </div>
            </div>
            </div>
